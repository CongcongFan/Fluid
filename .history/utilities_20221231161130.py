...
def smoothing(Nx, Ny, phi, S, aE, aW, aN, aS, a0, x_list1, yf_list, xc_list,yc_list):
    ...
    f = interpolate.RectBivariateSpline(x_list1, yf_list, Rf_new)
    Rc_new = f(xc_list, yc_list)

    return Rc_new, R2f

def restriction(Nxc, Nyc, phic, Rc_new, aEc, aWc, aNc, aSc, a0c, x_list1, yf_list, xc_list, yc_list):
    ...
    phif_corrector = f(x_list1, yf_list)
