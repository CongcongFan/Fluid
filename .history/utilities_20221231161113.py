...
def smoothing(Nx, Ny, phi, S, aEf, aWf, aNf, aSf, a0f, xf_list, yf_list, xc_list,yc_list):

    phif = GS(Nx, Ny, phi, S, aEf, aWf, aNf, aSf, a0f)

    R2f, Rsumf, Rf_new = residual(Nx, Ny, phi, S, aEf, aWf, aNf, aSf, a0f, convert=False)
