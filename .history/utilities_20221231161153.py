...
def smoothing(Nx, Ny, phi, S, aE, aW, aN, aS, a0, x_list1, y_list, x_list2,y_list)2:
    ...
    Rc_new = f(x_list2, c_list2)

    return Rc_new, R2f

def restriction(Nxc, Nyc, phic, Rc_new, aEc, aWc, aNc, aSc, a0c, x_list1, y_list, x_list2, c_list2):
    ...
    f = interpolate.RectBivariateSpline(x_list2, c_list2, phic)
