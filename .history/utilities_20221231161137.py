...
def smoothing(Nx, Ny, phi, S, aE, aW, aN, aS, a0, x_list1, y_list1, x_list2,y_list):
...
def restriction(Nxc, Nyc, phic, Rc_new, aEc, aWc, aNc, aSc, a0c, x_list1, y_list1, x_list2, c_list):
