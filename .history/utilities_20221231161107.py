...
def smoothing(Nx, Nyf, phif, Sf, aEf, aWf, aNf, aSf, a0f, xf_list, yf_list, xc_list,yc_list):

    phif = GS(Nx, Nyf, phif, Sf, aEf, aWf, aNf, aSf, a0f)

    R2f, Rsumf, Rf_new = residual(Nx, Nyf, phif, Sf, aEf, aWf, aNf, aSf, a0f, convert=False)
...
def restriction(Nxc, Nyc, phic, Rc_new, aEc, aWc, aNc, aSc, a0c, xf_list, yf_list, xc_list, yc_list):
